...
== Description ==
	...
	- Send me a mail to "support@finbey.de"  
...
== Installation ==
	...
	2.1 Add [category_posts=2] if you only want to show 2 posts. 
		If you want to display ten posts from cat_id 1, it should look like this:  [category_id=1][category_posts=10].
	2.2 See FAQ for "Howto find category id"
	3. Thats it.
...
== Frequently Asked Questions ==
	...
	= Why is it untranslated? =
		...
		Wordpress 4 and above
		
		1. Open Settings -> General in your WordPress backend.
		2. Scroll down to "Site Language"
		3. Set your prefered language.
		4. Now Single Categories should work fine.
		
	
		Wordpress Versions under 4.0
		
		When you don't set you language in you wp-config.php file, 
		the plugin don't know what to translate.
		
			
	= How can I manually set my language in wp-config.php (Wordpress < 4.0) = 
	...
	= I want to display more than 5 Posts in one of my Pages, what to do? =
	
		After inserted [category_id=x] you can additional add [category_posts=x] for how much posts it should display.
		i.e if you write [category_id=1][category_posts=123] it displays 123 Posts of the category 1.
...
== Changelog == 
	...
	* Changed FAQ for Wordpress 4.0 language settings

	= 1.5 =
	* Added support for WP 3.8
	* Included Post limiter
